...
public class JopApiDigest {
    ...
    public boolean validate(String signature, String appKey, String token, String timestamp, String random) {
        ...
        System.out.println((new StringBuilder("JopApiDigest validate parameter list:signature= ").append(signature)
                .append(", expectedSignature= ").append(expectedSignature).append(", appKey= ").append(appKey)
                .append(", token= ").append(token).append(", timestamp= ").append(timestamp).append(", random= ").append(random)));
        return flag;
    }
}
